...
export function MolkkoutScreen() {
  ...
  if (mg.status === 'finished') {
    ...
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center bg-gray-50 px-6 gap-6">
        ...
        <button
          ...
          className="w-full max-w-sm py-4 rounded-2xl bg-blue-500 text-white text-lg font-semibold"
        >
          ホームに戻る
        </button>
      </div>
